...
class Calendar extends Component{
    ...
    render(){
        ...
        for(let i = 0;i < data.offset;i++){
            offsetRow.push(<div key={i} className="calendar-item"></div>)
        }
        ...
        return(
            <div className="calendar">
                <header>
                    ...
                    {
                        arrow_side == "left" && <div className="arrow_container arrow_container_left">
                    ...
                    <p className={arrow_side == "left" ? "title title_left" : "title title_right"}>{data.title}</p>
                    
                    
                    {
                        arrow_side == "right" && <div className="arrow_container arrow_container_right">
                    ...
                    <div className="calendar-row">
                        ...
                        }
                        {
                            data.days.map((value,key)=>{
                                ...
                                return(
                                    <div key={key} className={classes} onClick={this._dayClickHandler} data-time-unix={value.unix_time}>
                                        {value.num}
                                    </div>
                                )
                            })
...
export default connect(mapStateToProps,{selectDay,generateCalendar,changeShowedMonth})(Calendar);